"""
train.py — 主入口（72B 多卡版）

用法示例（昇腾 8 卡，device_map="auto" 自动分片）：
    python train.py \
        --llm_name /mnt/nvme0/models/Qwen2.5-Math-72B-Instruct \
        --device npu:0 \
        --dataset_name gsm8k \
        --G 4 \
        --L 10 \
...
def parse_args():
    ...
    # 模型
    parser.add_argument("--llm_name", default="Qwen/Qwen2.5-Math-72B-Instruct")
